...
void i2c_init() {
    // Initialise I2C MSSP
    SSPCON1  = 0b00111110; // 8:WCOL(0) 7:SSP1OV(0) 6:SSP1EN(1) 5:CKP(1) 1..4:SSPM(1110 I2C Slave mode, 7-bit address with Start and Stop bit interrupts enabled)
    SSPCON2  = 0b11100000; // 8:GCEN(1) 7:ACKSTAT(1) 6:ACKDT(1) 5:ACKEN(0) 4:RCEN(0) 3:PEN(0) 2:RSEN(0) 1:SEN(0)
    SSPCON3  = 0b01100100; // 8:ACKTIM(0) 7:PCIE(1) 6:SCIE(1) 5:BOEN(0) 4:SDAHT(0) 3:SBCDE(1) 2:AHEN(0) 1:DHEN(0)
    // I2C Master mode, clock = FOSC/(4 * (SSPADD + 1))
    SSPADD = I2C_MYADDR; // My address
    SSPMSK = 0b11111110;// Match every single address
