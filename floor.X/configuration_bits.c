...
// CONFIG2
#pragma config WRT = BOOT       // Flash Memory Self-Write Protection (000h to 1FFh write protected, 200h to 3FFFh may be modified by EECON control)
#ifndef _12F1840
#pragma config VCAPEN = OFF//RA5//0b01 // RA5     // Voltage Regulator Capacitor Enable (All VCAP pin functionality is disabled)
#endif
